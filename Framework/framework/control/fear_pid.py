...
from framework.control.fuzzy_pid import FuzzyConfig, FuzzyPIDController
from framework.control.pid import PIDGains
...
class FEARPIDController:
    def __init__(
        ...
        self.controller = FuzzyPIDController(base_gains=base_gains, fuzzy=fuzzy)
