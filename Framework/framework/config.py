...
class DelayConfig:
    ...
    queue_model: str = "mm1"  # mm1 | backlog
...
def load_config(path: Optional[str]) -> Config:
    ...
    if isinstance(data, dict) and "include" in data:
        ...
        for inc in include_paths:
            ...
            inc_data = load_config(str(inc_path)).to_dict()
